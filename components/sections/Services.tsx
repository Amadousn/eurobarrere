  ...
  return (
    <section className="py-24 bg-surface grain-texture">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="mb-16">
          <h2 className="font-display text-4xl md:text-6xl font-black text-light mb-4 uppercase">
          ...
          {services.map((service) => {
            ...
            return (
              <Link
                key={service.number}
                href={service.href}
                className="group relative bg-primary p-8 border-l-4 border-accent hover:bg-surface transition-all duration-300 hover:translate-x-2"
              >
                <div className="absolute top-4 right-4 text-[120px] font-display font-black text-light/5 leading-none pointer-events-none">
                  {service.number}
                </div>
                ...
                <div className="relative z-10">
                  ...
                  <h3 className="font-display text-2xl font-bold text-light mb-3 uppercase tracking-tight">
                    {service.title}
                  </h3>
